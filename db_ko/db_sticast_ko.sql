CREATE DATABASE  IF NOT EXISTS `db_sticast_ko` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `db_sticast_ko`;
...
INSERT INTO `account` VALUES (1,'admin','admin123','admin','admin@admin.it',100,1),(2,'pippo','pippo123','Pippo','pippo@pippo.it',100,0);
...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `fk_Commenti_Domanda1` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`)
...
INSERT INTO `question` VALUES (1,1,'Will bitcoin succeed in exceeding the 10k$ threshold by 2020?',0.5,0.5,0,0,1,0,'01/01/2020','31/12/2020'),(2,2,'Will SSC Napoli win Serie A 2020/21?',0.5,0.5,0,0,1,0,'15/08/20','01/05/2021'),(3,2,'Will LeClerc win the F1 World Championship 2020?',0.5,0.5,0,0,1,0,'01/01/2020','31/12/2020'),(4,1,'Will Ethereum be able to return to $1000 by December?',0.5,0.5,0,0,1,0,'01/01/2020','31/12/2020'),(5,4,'Italy\'s GDP will grow in the third quarter?',0.5,0.5,0,0,1,0,'01/05/2020','31/12/2020'),(6,3,'Will Trump succeed in building the wall?',0.5,0.5,0,0,0,0,'01/05/2018','31/12/2018'),(7,3,'Will Trump be re-elected in 2020?',0.5,0.5,0,0,1,0,'01/01/2020','1/11/2020');
...
-- Dump completed on 2018-09-03 17:26:31
